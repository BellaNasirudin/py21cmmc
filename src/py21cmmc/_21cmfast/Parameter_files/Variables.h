...
#define TOTAL_AVAILABLE_PARAMS (int) (18)
...
int NUM_BINS, CREATE_FFT_DATA_FROM_FILE,READ_FFT_DATA_FROM_FILE,SHORTEN_FCOLL,N_USER_REDSHIFT, WALKER_FILE_LENGTH, USE_LIGHTCONE,CALC_PS,USE_TS_FLUCT,INHOMO_RECO,STORE_DATA,ERFC_NUM_POINTS, erfc_arg_val_index,READ_FROM_FILE,PRINT_FILES,PRINT_COEVAL_21cmBoxes,PRINT_LIGHTCONE_21cmBoxes;
...
double INDIVIDUAL_ID, INDIVIDUAL_ID_2,Z_HEAT_MAX,ZPRIME_STEP_FACTOR;
